    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex gap-2">
                ...
                @if($type == 'in_house')
                    {{ translate('in_House_Food_List') }}
                @elseif($type == 'seller')
                    {{ translate('vendor_Food_List') }}
                @endif
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ url()->current() }}" method="GET">
                    ...
                    <div class="row gx-2">
                        <div class="col-12">
                            <h4 class="mb-3">{{ translate('filter_Foods') }}</h4>
                        </div>
                        ...
                        @endif
                        <div class="col-sm-6 col-lg-4 col-xl-3 d-none">
                            <div class="form-group">
                            ...
                            <div class="col-lg-8 mt-3 mt-lg-0 d-flex flex-wrap gap-3 justify-content-lg-end">
                                ...
                                @if($type == 'in_house')
                                    ...
                                    <a href="{{ route('admin.products.add') }}" class="btn btn--primary">
                                        <i class="tio-add"></i>
                                        <span class="text">{{ translate('add_new_food') }}</span>
                                    </a>
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="table-responsive">
                        <table id="datatable"
                            ...
                            <tr>
                                ...
                                <th class="text-center">{{ translate('food Type') }}</th>
