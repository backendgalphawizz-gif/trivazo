...
@section('content')
    @php($isFoodProduct = (bool)($product->is_food ?? false))
    <div class="content container-fluid">
        <div class="d-flex flex-wrap gap-2 align-items-center mb-3">
            <h2 class="h1 mb-0 d-flex align-items-center gap-2">
                <img src="{{ dynamicAsset(path: 'public/assets/back-end/img/inhouse-product-list.png') }}" alt="">
                {{ $isFoodProduct ? 'Edit Food' : translate(request('product-gallery')==1 ?'product_Add' : 'product_Edit') }}
            </h2>
        </div>
        ...
        <form class="product-form text-start" action="{{ request('product-gallery')==1? route('admin.products.add') : route('admin.products.update',$product->id) }}" method="post"
            ...
            <div class="card">
                ...
                <div class="card-body">
                    @foreach($languages as $language)
                            ...
                            ?>
                        <div class="{{ $language != $defaultLanguage ? 'd-none' : ''}} form-system-language-form" id="{{ $language}}-form">
                            <div class="form-group">
                                <label class="title-color" for="{{ $language}}_name">
                                    {{ $isFoodProduct ? translate('food_name') : translate('product_name') }}
                                    ({{strtoupper($language) }})
                                ...
                                <input type="text" {{ $language == $defaultLanguage ? 'required' : ''}} name="name[]"
                                       ...
                                       class="form-control {{ $language == $defaultLanguage ? 'product-title-default-language' : '' }}" placeholder="{{ $isFoodProduct ? translate('new_Food') : translate('new_Product') }}" required>
                            </div>
                            <input type="hidden" name="lang[]" value="{{ $language}}">
                            <div class="form-group pt-4">
                                <label class="title-color">{{ translate('description') }}
                                    ({{strtoupper($language) }})</label>
                                <textarea name="description[]" class="summernote {{ $language == $defaultLanguage ? 'product-description-default-language' : '' }}"
            ...
            <div class="card mt-3 rest-part">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3 {{ $isFoodProduct ? 'd-none' : '' }}">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="title-color d-flex justify-content-between gap-2">
                                    <span class="d-flex align-items-center gap-2">
                                        {{ $isFoodProduct ? translate('Food_SKU') : translate('product_SKU') }}
                                        <span class="input-required-icon">*</span>
                                        <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
            ...
            <div class="card mt-3 rest-part">
                <div class="card-header">
                    <div class="d-flex gap-2">
                        <i class="tio-user-big"></i>
                        <h4 class="mb-0">{{ $isFoodProduct ? translate('pricing_&_others') : translate('Pricing_&_others') }}</h4>
                    </div>
                </div>
            ...
            @include('admin-views.product.partials._food-fields', ['product' => $product])

            <div class="card mt-3 rest-part digitalProductVariationSetupSection {{ $isFoodProduct ? 'd-none' : '' }}">
                <div class="card-header">
                    <div class="d-flex gap-2">
                        <i class="tio-user-big"></i>
            ...
            <div class="card mt-3 rest-part {{ $isFoodProduct ? 'd-none' : '' }}" id="digital-product-variation-section"></div>

            <div class="card mt-3 rest-part physical_product_show {{ $isFoodProduct ? 'd-none' : '' }}">
                <div class="card-header">
                    <div class="d-flex gap-2">
                        <i class="tio-user-big"></i>
                        <h4 class="mb-0">{{ translate('product_variation_setup') }}</h4>
            ...
            <div class="mt-3 rest-part">
                <div class="product-image-wrapper">
                                ...
                                <div class="d-flex align-items-center justify-content-between gap-2 mb-3">
                                    <div>
                                        <label for="name" class="title-color text-capitalize font-weight-bold mb-0">
                                            {{ $isFoodProduct ? translate('food_thumbnail') : translate('product_thumbnail') }}
                                            <span class="input-required-icon">*</span>
                                        </label>
                                        <span
                    ...
                    <div class="item-2 color_image_column {{ $isFoodProduct ? '' : 'd-none' }}">
                        <div class="card h-100">
                            <div class="card-body">
                    ...
                    <div class="additional_image_column item-2">
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <p class="text-muted">{{ $isFoodProduct ? translate('upload_additional_food_images') : translate('upload_additional_product_images') }}</p>
            ...
            <div class="card mt-3 rest-part {{ $isFoodProduct ? 'd-none' : '' }}">
                <div class="card-header">
                    <div class="d-flex gap-2">
                        <i class="tio-user-big"></i>
...
@push('script')
    ...
    @include('admin-views.product.partials._food-addon-script')
