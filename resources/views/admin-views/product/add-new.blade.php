        ...
        <form class="product-form text-start" action="{{ route('admin.products.store') }}" method="POST"
            ...
            <div class="card">
                <div class="px-4 pt-3 d-flex justify-content-between">
                    ...
                    <a class="d-none btn btn--primary btn-sm text-capitalize h-100" href="{{route('admin.products.product-gallery') }}">
                        ...
                        <div class="{{ $lang != $defaultLanguage ? 'd-none' : '' }} form-system-language-form"
                            ...
                            <div class="form-group">
                                <label class="title-color"
                                       for="{{ $lang }}_name">{{ translate('food_name') }}
                                    ({{ strtoupper($lang) }})
                                ...
                                <input type="text" {{ $lang == $defaultLanguage ? 'required' : '' }} name="name[]"
                                       id="{{ $lang }}_name" class="form-control {{ $lang == $defaultLanguage ? 'product-title-default-language' : '' }}" placeholder="{{ translate('new_Food') }}">
                            </div>
                                ...
                                <div
                                    ...
                                    <div class="d-flex gap-2">
                                        <label class="title-color text-capitalize"
                                               for="shipping_cost">{{ translate('Delivery_cost_multiply_with_quantity') }}</label>
            ...
            @include('admin-views.product.partials._food-fields')
                    ...
                    <div class="additional_image_column item-2">
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <p class="text-muted">{{ translate('upload_additional_food_images') }}</p>
