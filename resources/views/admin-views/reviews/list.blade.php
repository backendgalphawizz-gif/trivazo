        ...
        <div class="card card-body">
            <form action="{{ url()->current() }}" method="GET">
                <div class="row gy-3 align-items-end">
                    <div class="col-md-4">
                        <label for="name" class="title-color">{{ translate('foods')}}</label>
                        <div class="dropdown select-product-search w-100">
                            ...
                            <button class="form-control text-start dropdown-toggle text-truncate select-product-button"
                                ...
                                {{request('product_id') !=null ? $product['name']: translate('select_foods')}}
                            </button>
                            <div class="dropdown-menu w-100 px-2">
                                <div class="search-form mb-3">
                                    <button type="button" class="btn"><i class="tio-search"></i></button>
                                    <input type="text" class="js-form-search form-control search-bar-input search-product" placeholder="{{translate('search_foods').'...'}}">
                                </div>
                ...
                <form action="{{ url()->current() }}" method="GET">
                    <div class="input-group input-group-merge input-group-custom">
                        ...
                        <input id="datatableSearch_" type="search" name="searchValue" class="form-control"
                               placeholder="{{ translate('search_by_food_or_Customer') }}"
                            ...
                            <td>
                                <div class="d-flex gap-2 justify-content-center">
                                    ...
                                    @elseif($review?->product?->added_by == 'seller')
                                        <div>
                                            <a class="btn btn-outline-primary btn-sm square-btn" title="{{ translate('Admin_can_not_reply_to_vendor_food_review') }}" data-toggle="tooltip">
                                                @if($review?->reply)
                                                    <i class="tio-edit"></i>
                                                @else
                                                    <i class="tio-reply-all"></i>
                                    ...
                                    @else
                                        <div>
                                            <a class="btn btn-outline-primary btn-sm square-btn" title="{{ translate('food_not_found') }}" data-toggle="tooltip">
                                                @if($review?->reply)
                                                    <i class="tio-edit"></i>
                                                @else
                                                    <i class="tio-reply-all"></i>
                                ...
                                <form method="POST" action="{{ route('admin.reviews.add-review-reply') }}">
                                    ...
                                    <div class="modal-body pt-0">
                                        ...
                                        <textarea class="form-control text-area-max-min" rows="3" name="reply_text"
                                                  placeholder="{{ translate('Write_the_reply_of_the_food_review') }}...">{{ $review?->reply?->reply_text ?? '' }}</textarea>
