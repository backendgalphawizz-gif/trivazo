    ...
    <div class="content container-fluid">
        ...
        <div class="store-report-content mb-2">
            <div class="left-content">
                <div class="left-content-card">
                    ...
                    <div class="info">
                        ...
                        <h6 class="subtext">{{translate('total_Food')}}</h6>
                    </div>
                ...
                <div class="left-content-card">
                    ...
                    <div class="info">
                        ...
                        <h6 class="subtext">{{translate('total_Food_Sale')}}</h6>
                    </div>
                </div>
                <div class="left-content-card">
            ...
            <div class="center-chart-area">
                @include('layouts.back-end._apexcharts',['title'=>'food_Statistics','statisticsValue'=>$chart_data['total_product'],'label'=>array_keys($chart_data['total_product']),'statisticsTitle'=>'total_product','getCurrency'=>false])
            </div>
        </div>
        ...
        <div class="card">
                    ...
                    <form action="#" method="GET">
                        <div class="input-group input-group-merge input-group-custom">
                            ...
                            <input id="datatableSearch_" type="search" name="search" class="form-control"
                                   placeholder="{{translate('search_food_name')}}" aria-label="Search orders"
                                   value="{{ $search }}">
                ...
                <div class="table-responsive" id="products-table">
                    <table
                        ...
                        <tr>
                            ...
                            <th>
                                <span>{{translate('average_Food_Value')}} </span>
                            </th>
                            <th>
            ...
            @if(count($products)==0)
                @include('layouts.back-end._empty-state',['text'=>'no_food_found'],['image'=>'default'])
            @endif
        </div>
    </div>  
@endsection
