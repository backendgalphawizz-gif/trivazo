                ...
                <div class="card">
                                ...
                                <form action="{{ url()->current() }}" method="GET">
                                    <div class="input-group input-group-merge input-group-custom width-500px">
                                        ...
                                        <input id="datatableSearch_" type="search" name="searchValue" class="form-control"
                                            placeholder="{{translate('search_by_bussiness_name_or_vendor_name_or_phone_or_email')}}" aria-label="Search orders" value="{{ request('searchValue') }}">
                    ...
                    <div class="table-responsive">
                        <table
                            ...
                            <tr>
                                <th>{{translate('SL')}}</th>
                                <th>{{translate('bussiness_name')}}</th>
                                <th>{{translate('vendor_name')}}</th>
                                <th>{{translate('vendor_type')}}</th>
                                <th>{{translate('contact_info')}}</th>
                                <th>{{translate('status')}}</th>
                                {{-- <th class="text-center">{{translate('total_food_products')}}</th>
