...
@section('title', $seller?->shop->name ?? translate("bussiness_name_not_found"))
    ...
    <div class="content container-fluid">
                ...
                @if ($seller->status=="pending")
                    <div class="mt-4 pr-2">
                        <div class="flex-between">
                            ...
                            <div><h4>{{translate('vendor_request_for_onboarding.')}}</h4></div>
                        </div>
        ...
        <div class="page-header">
            <div class="flex-between row mx-1">
                <div>
                    <h1 class="page-header-title">{{ $seller?->shop->name ?? translate("bussiness_Name")." : ".translate("update_Please") }}</h1>
                </div>
            </div>
                                    ...
                                    <form action="{{ url()->current() }}" method="GET">
                                        <div class="input-group input-group-merge input-group-custom">
                                            ...
                                            <input id="datatableSearch_" type="search" name="searchValue"
                                                   class="form-control"
                                                   placeholder="{{translate('search_by_food_name')}}" aria-label="Search orders"
