...
<div class="col-sm-6 col-lg-3">
    <a class="business-analytics get-view-by-onclick card" href="{{route('admin.vendors.vendor-list')}}">
        <h5 class="business-analytics__subtitle">{{translate('total_Sellers')}}</h5>
...
<div class="col-sm-6 col-lg-3">
    <a class="business-analytics card">
        <h5 class="business-analytics__subtitle">{{translate('total_Foods')}}</h5>
...
<div class="row g-2 col-12">
    ...
    <div class="col-sm-6 col-lg-3">
        ...
        <div class="order-stats order-stats_failed cursor-pointer">
            <div class="order-stats__content">
                <img width="20" src="{{dynamicAsset(path: 'public/assets/back-end/img/packaging.png')}}" alt="">
                <h6 class="order-stats__subtitle">{{translate(' Pending approvals & alerts')}}</h6>
            </div>
            <span class="order-stats__title h3">{{$data['failed']}}</span>
        </div>
    </div>
