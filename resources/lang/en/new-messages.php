...
return [
	...
	"food_dashboard_overview" => "Food dashboard overview",
	"food_business_analytics" => "Food business analytics",
	"food_admin_wallet" => "Food admin wallet",
	"food_user_overview" => "Food user overview",
	"tow_dashboard" => "Tow dashboard",
	"tow_provider_dashboard_overview" => "Tow provider dashboard overview",
	"tow_business_analytics" => "Tow business analytics",
	"tow_admin_wallet" => "Tow admin wallet",
	"tow_user_overview" => "Tow user overview",
	"Tow Dashboard" => "Tow Dashboard",
	"Tow Provider Dashboard" => "Tow Provider Dashboard",
	"Monitor tow service analytics and performance" => "Monitor tow service analytics and performance",
	"no_category_found" => "No category found",
	"monitor_your_food_business_analytics_and_statistics" => "Monitor your food business analytics and statistics",
	"monitor_your_tow_business_analytics_and_statistics" => "Monitor your tow business analytics and statistics",
	"Hotel_List" => "Hotel List",
	"hotel_management" => "Hotel management",
	"hotels" => "Hotels",
	"pending_hotels" => "Pending hotels",
	"approved_hotels" => "Approved hotels",
	"rejected_hotels" => "Rejected hotels",
	"all_hotels" => "All hotels",
	"bookings" => "Bookings",
	"room_inventory" => "Room inventory",
	"view_all_hotels" => "View all hotels",
	"approve/reject_hotel_listings" => "Approve/reject hotel listings",
	"manage_room_inventory_visibility" => "Manage room inventory visibility",
	"monitor_bookings_&_cancellations" => "Monitor bookings & cancellations",
	"cancel_bookings" => "Cancel bookings",
	"View All Hotels" => "View All Hotels",
	"Search by hotel name, city, email" => "Search by hotel name  city  email",
	...
	"search_by_hotel_name_city_email" => "Search by hotel name city email",
	...
	"please_try_again_with_different_filters" => "Please try again with different filters",
	...
	"amenities" => "Amenities",
	"or_add_custom_amenities" => "Or add custom amenities",
	"enter_amenity" => "Enter amenity",
	"policies" => "Policies",
	...
	"image_format_jpg_png_jpeg" => "Image format jpg png jpeg",
	"max_size_2mb" => "Max size 2mb",
	"enter_image_alt_text" => "Enter image alt text",
	...
	"Enter room count" => "Enter room count",
	...
	"Click and drag the marker to set location" => "Click and drag the marker to set location",
	"Amenities" => "Amenities",
	"Add Custom Amenities" => "Add Custom Amenities",
	"Enter amenity" => "Enter amenity",
	...
	"Notes" => "Notes",
	"Enter cancellation policy" => "Enter cancellation policy",
	"Child Policy" => "Child Policy",
	"Enter child policy" => "Enter child policy",
	"Pet Policy" => "Pet Policy",
	"Enter pet policy" => "Enter pet policy",
	"Payment Policy" => "Payment Policy",
	"Enter payment policy" => "Enter payment policy",
	"Smoking Policy" => "Smoking Policy",
	"Enter smoking policy" => "Enter smoking policy",
	"Additional Notes" => "Additional Notes",
	"Enter additional notes" => "Enter additional notes",
	"Images" => "Images",
	"Featured Image" => "Featured Image",
	"Choose File" => "Choose File",
	"Image format: jpg, png, jpeg | Max size: 2MB" => "Image format: jpg  png  jpeg | Max size: 2MB",
	"Gallery Images" => "Gallery Images",
	"Choose Multiple Files" => "Choose Multiple Files",
	"Search location" => "Search location",
	"Please enter an amenity" => "Please enter an amenity",
	"Hotel name is required" => "Hotel name is required",
	"Please select a seller" => "Please select a seller",
	"Number of rooms must be greater than 0" => "Number of rooms must be greater than 0",
	"Price per night is required" => "Price per night is required",
	"Email is required" => "Email is required",
	"Phone is required" => "Phone is required",
	"Address is required" => "Address is required",
	"enter_total_rooms" => "Enter total rooms",
	"hotel_description" => "Hotel description",
	"provide_detailed_description_of_your_hotel" => "Provide detailed description of your hotel",
	"enter_cancellation_policy" => "Enter cancellation policy",
	"enter_child_policy" => "Enter child policy",
	"enter_pet_policy" => "Enter pet policy",
	"enter_payment_policy" => "Enter payment policy",
	"enter_smoking_policy" => "Enter smoking policy",
	"enter_hotel_description" => "Enter hotel description",
	"please_enter_an_amenity" => "Please enter an amenity",
	"amenity_added" => "Amenity added",
	"files_selected" => "Files selected",
	"hotel_name_is_required" => "Hotel name is required",
	"please_select_a_seller" => "Please select a seller",
	...
	"back_to_list" => "Back to list",
	"brief_description_about_hotel" => "Brief description about hotel",
	"full_description" => "Full description",
	"basic_hotel_information_and_settings" => "Basic hotel information and settings",
	"hotel_code" => "Hotel code",
	"unique_identifier_for_the_hotel" => "Unique identifier for the hotel",
	...
	"enter_alternate_phone" => "Enter alternate phone",
	"minimum_stay" => "Minimum stay",
	"nights" => "Nights",
	"maximum_stay" => "Maximum stay",
	"child_age_limit" => "Child age limit",
	"add_search_tags_for_better_discoverability" => "Add search tags for better discoverability",
	...
	"metro" => "Metro",
	"amenities_&_services" => "Amenities & services",
	"select_hotel_amenities_and_services" => "Select hotel amenities and services",
	"popular" => "Popular",
	"family" => "Family",
	"accessibility" => "Accessibility",
	"custom_amenities" => "Custom amenities",
	"enter_custom_amenity" => "Enter custom amenity",
	"room_variations" => "Room variations",
	"configure_different_room_types_and_prices" => "Configure different room types and prices",
	"room_type" => "Room type",
	"max_adults" => "Max adults",
	"max_children" => "Max children",
	"add_room_variation" => "Add room variation",
	...
	"upload_featured_image_for_hotel" => "Upload featured image for hotel",
	"describe_image_for_seo" => "Describe image for seo",
	"hotel_logo" => "Hotel logo",
	"upload_multiple_hotel_images" => "Upload multiple hotel images",
	...
	"saturday" => "Saturday",
	"sunday" => "Sunday",
	"add_meta_information_for_better_search_visibility" => "Add meta information for better search visibility",
	"enter_meta_title" => "Enter meta title",
	"character_limit" => "Character limit",
	"meta_keywords" => "Meta keywords",
	"enter_keywords_comma_separated" => "Enter keywords comma separated",
	"commission_type" => "Commission type",
	"tax_rate" => "Tax rate",
	"please_enter_valid_data" => "Please enter valid data",
	"want_to_add_this_hotel" => "Want to add this hotel",
	"hotel_added_successfully" => "Hotel added successfully",
	"invalid_file_type" => "Invalid file type",
	"select_option" => "Select option",
	"at_least_one_place_required" => "At least one place required",
	"at_least_one_room_required" => "At least one room required",
	...
	"in-House_food" => "In-House food",
	"in-house_foods" => "In-house foods",
	"food_List" => "Food List",
	"add_New_food" => "Add New food",
	"vendor_food" => "Vendor food",
	"vendor_foods" => "Vendor foods",
	"new_food_Requests" => "New food Requests",
	"approved_foods" => "Approved foods",
	"denied_foods" => "Denied foods",
	...
	"select_sub_category" => "Select sub category",
	"food" => "Food",
	"banner_image_ratio_is_not_same_for_all_sections_in_app" => "Banner image ratio is not same for all sections in app",
	"banner_Image_ratio_is_not_same_for_all_sections_in_app" => "Banner Image ratio is not same for all sections in app",
	"if_enabled_this_banner_will_be_available_on_the_customer_app" => "If enabled this banner will be available on the customer app",
	"if_disabled_this_banner_will_be_hidden_from_the_customer_app" => "If disabled this banner will be hidden from the customer app",
	...
	"hotel commission his..." => "Hotel commission his...",
	...
	"vendor_type_selection" => "Vendor type selection",
	"vendor_type" => "Vendor type",
	"food_vendor" => "Food vendor",
	"hotel_vendor" => "Hotel vendor",
	"configuring_commission_for_food_vendor" => "Configuring commission for food vendor",
	"food_commission_type" => "Food commission type",
	"fixed_rate" => "Fixed rate",
	"enter_fixed_rate" => "Enter fixed rate",
	"percentage_rate" => "Percentage rate",
	"enter_percentage" => "Enter percentage",
	"configuring_commission_for_hotel_vendor" => "Configuring commission for hotel vendor",
	...
	"configure_vendor_commission" => "Configure vendor commission",
	"top_selling_food" => "Top selling food",
	"most_Popular_Food" => "Most Popular Food",
	"The_vendor_type_field_is_required" => "The vendor type field is required",
	"Invalid_vendor_type_selected" => "Invalid vendor type selected",
	"The_commission_type_field_is_required" => "The commission type field is required",
	"Invalid_commission_type_selected" => "Invalid commission type selected",
	"The_fixed_rate_is_required_when_commission_type_is_fixed" => "The fixed rate is required when commission type is fixed",
	"The_fixed_rate_must_be_a_number" => "The fixed rate must be a number",
	"The_percentage_rate_is_required_when_commission_type_is_percentage" => "The percentage rate is required when commission type is percentage",
	"The_percentage_rate_must_be_a_number" => "The percentage rate must be a number",
	"The_percentage_rate_may_not_be_greater_than_100" => "The percentage rate may not be greater than 100",
	"search_by_bussiness_name_or_vendor_name_or_phone_or_email" => "Search by bussiness name or vendor name or phone or email",
	"in_House_Food_List" => "In House Food List",
	...
	"food Type" => "Food Type",
	"food_name" => "Food name",
	"vendor_Food_List" => "Vendor Food List",
	"no_food_found" => "No food found",
	"total_food" => "Total food",
	"new_Food" => "New Food",
	"Food_SKU" => "Food SKU",
	"Delivery_cost" => "Delivery cost",
	"Delivery_cost_multiply_with_quantity" => "Delivery cost multiply with quantity",
	"food_thumbnail" => "Food thumbnail",
	"upload_additional_food_images" => "Upload additional food images",
	"no_coupon_found" => "No coupon found",
	"end Date" => "End Date",
	"Food_Name" => "Food Name",
	"view_all_rooms" => "View all rooms",
	"Food Name" => "Food Name",
	"clearance_sale_food" => "Clearance sale food",
	"total_In_House_Food" => "Total In House Food",
	"search_by_food_name" => "Search by food name",
	"total_Vendor_Food" => "Total Vendor Food",
	...
	"are_you_sure_to_delete_this_hotel" => "Are you sure to delete this hotel",
	"reject_hotel" => "Reject hotel",
	"please_provide_reason_for_rejection" => "Please provide reason for rejection",
	"rejection_reason" => "Rejection reason",
	"enter_rejection_reason" => "Enter rejection reason",
	"business_name" => "Business name",
	"total_food_amount" => "Total food amount",
	"food_discount" => "Food discount",
	"all_Food" => "All Food",
	"food_Stock" => "Food Stock",
	"wish_Listed_Food" => "Wish Listed Food",
	"total_Food" => "Total Food",
	"total_Food_Sale" => "Total Food Sale",
	"product_Food" => "Product Food",
	"food_Statistics" => "Food Statistics",
	"food_Product" => "Food Product",
	"food_Name" => "Food Name",
	"average_Food_Value" => "Average Food Value",
	"search_food_name" => "Search food name",
	"food_Discount" => "Food Discount",
	"foods" => "Foods",
	"select_foods" => "Select foods",
	"search_foods" => "Search foods",
	"search_by_food_or_Customer" => "Search by food or Customer",
	"food_info" => "Food info",
	...
	"room_size_sqft" => "Room size sqft",
	"rooms_available" => "Rooms available",
	"pricing_details" => "Pricing details",
	"single_price" => "Single price",
	"single_sale_price" => "Single sale price",
	"double_price" => "Double price",
	"double_sale_price" => "Double sale price",
	"extra_adult_price" => "Extra adult price",
	"extra_child_price" => "Extra child price",
	...
	"arrived" => "Arrived",
	"in_progress" => "In progress",
	"search_by_amenity_name_or
                                               _category_name" => "Search by amenity name or  category name",
	...
	"search_by_amenitty_name_or_category" => "Search by amenitty name or category",
	"total_providers" => "Total providers",
	"total_trips" => "Total trips",
	"on_break" => "On break",
	"search_by_company_or_owner" => "Search by company or owner",
	"no_providers_found" => "No providers found",
	"add_your_first_tow_provider" => "Add your first tow provider",
	...
	"select_an_existing_user_to_become_a_tow_provider" => "Select an existing user to become a tow provider",
	"company_name" => "Company name",
	"enter_company_name" => "Enter company name",
	"service_area" => "Service area",
	"e.g._Downtown,_Suburbs" => "E.g. Downtown  Suburbs",
	"max_simultaneous_trips" => "Max simultaneous trips",
	"maximum_number_of_trips_a_provider_can_handle_at_once" => "Maximum number of trips a provider can handle at once",
	"documents" => "Documents",
	"business_license" => "Business license",
	"upload_business_license_in_pdf_format" => "Upload business license in pdf format",
	"upload_license" => "Upload license",
	"PDF, DOC up to 5MB" => "PDF  DOC up to 5MB",
	"insurance_document" => "Insurance document",
	"upload_insurance_document_in_pdf_format" => "Upload insurance document in pdf format",
	...
	"scheduled" => "Scheduled",
	"battery jump" => "Battery jump",
	"flat tire" => "Flat tire",
	"fuel delivery" => "Fuel delivery",
	"search_by_customer" => "Search by customer",
	"tow_requests_list" => "Tow requests list",
	...
	"search_by_customer_or_provider" => "Search by customer or provider",
	"no_active_trips_found" => "No active trips found",
	"reassign_provider" => "Reassign provider",
	"select_new_provider" => "Select new provider",
	"reason_for_reassignment" => "Reason for reassignment",
	...
	"upload_mp4_webm_or_ogg_video_for_banner" => "Upload mp4 webm or ogg video for banner",
	"media" => "Media",
	"video_preview_is_not_supported_in_this_browser" => "Video preview is not supported in this browser",
	...
	"video_is_available_only_for_main_banner" => "Video is available only for main banner",
	"Customer_not_found!" => "Customer not found!",
	...
	"edit_hotel_service" => "Edit hotel service",
	"back_to_services" => "Back to services",
	"highlight" => "Highlight",
	"service" => "Service",
	"activity" => "Activity",
	"hotel_service_updated_successfully" => "Hotel service updated successfully",
	"back_to_hotel" => "Back to hotel",
	"add_service" => "Add service",
	"enter_short_description" => "Enter short description",
	"recommended_size" => "Recommended size",
	"select_a_hotel_to_manage_services" => "Select a hotel to manage services",
	"hotel_list" => "Hotel list",
	...
	"image_preview_will_show_here" => "Image preview will show here",
	"selected_image" => "Selected image",
	"select_one_image_for_room_thumbnail" => "Select one image for room thumbnail",
	"current_featured_image" => "Current featured image",
	"current_gallery_image" => "Current gallery image",
	"selected_featured_image" => "Selected featured image",
	"carpool_management" => "Carpool management",
	"drivers" => "Drivers",
	...
	"carpool_drivers" => "Carpool drivers",
	"total_drivers" => "Total drivers",
	"online_now" => "Online now",
	"suspended" => "Suspended",
	"unverified" => "Unverified",
	"name_phone_email_vehicle" => "Name phone email vehicle",
	...
	"e.g. Toyota Corolla 2022" => "E.g. Toyota Corolla 2022",
	...
	"pdf_jpg_png_max_5mb" => "Pdf jpg png max 5mb",
	"profile_photo" => "Profile photo",
	"upload_photo" => "Upload photo",
	"jpg_png_max_2mb" => "Jpg png max 2mb",
	"save_driver" => "Save driver",
	"add_trip" => "Add trip",
	"add_booking" => "Add booking",
	"add_new_trip" => "Add new trip",
	"back_to_trips" => "Back to trips",
	"how_carpool_works" => "How carpool works",
	"driver_adds_trip_info" => "Driver adds trip info",
	"passengers_book_seats_info" => "Passengers book seats info",
	"select_driver" => "Select driver",
	"select_a_driver" => "Select a driver",
	"max_seats" => "Max seats",
	"trip_route" => "Trip route",
	"origin_to_destination" => "Origin to destination",
	"origin_city_area" => "Origin city area",
	"e.g. Lahore, Gulberg" => "E.g. Lahore  Gulberg",
	"destination_city_area" => "Destination city area",
	"e.g. Islamabad, F-7" => "E.g. Islamabad  F-7",
	"estimated_distance_km" => "Estimated distance km",
	"estimated_duration_min" => "Estimated duration min",
	"schedule_and_seats" => "Schedule and seats",
	"departure_date_time" => "Departure date time",
	"ride_type" => "Ride type",
	"instant" => "Instant",
	"available_seats" => "Available seats",
	"seats_available_for_passengers" => "Seats available for passengers",
	"price_per_seat" => "Price per seat",
	"charged_per_seat_booked" => "Charged per seat booked",
	"full_booking_value" => "Full booking value",
	"if_all_seats_booked" => "If all seats booked",
	"note_for_passengers" => "Note for passengers",
	"any_instructions_or_info" => "Any instructions or info",
	"trip_summary" => "Trip summary",
	"seats" => "Seats",
	"price_seat" => "Price seat",
	"max_earnings" => "Max earnings",
	"publish_trip" => "Publish trip",
	"carpool_trips" => "Carpool trips",
	"full" => "Full",
	"departed" => "Departed",
	...
	"carpool_bookings" => "Carpool bookings",
	"total_bookings" => "Total bookings",
	...
	"verify_this_driver" => "Verify this driver",
	"view_trips" => "View trips",
	"view_bookings" => "View bookings",
	"Driver verified successfully." => "Driver verified successfully.",
	"e.g. Mumbai, Bandra" => "E.g. Mumbai  Bandra",
	"e.g. Delhi, Connaught Place" => "E.g. Delhi  Connaught Place",
	"search_origin_address" => "Search origin address",
	"type_to_search_address" => "Type to search address",
	"search_destination_address" => "Search destination address",
	...
	"jpg_png_max_3mb" => "Jpg png max 3mb",
	...
	"view_current_doc" => "View current doc",
	"current_document" => "Current document",
	"new_document_preview" => "New document preview",
	"edit_trip" => "Edit trip",
	"seats_already_booked" => "Seats already booked",
	"seat(s)_are_already_confirmed" => "Seat(s) are already confirmed",
	"total_seats_cannot_be_less_than_booked" => "Total seats cannot be less than booked",
	"total_seats" => "Total seats",
	"booked" => "Booked",
	"trip_status" => "Trip status",
	"changing_status_affects_booking" => "Changing status affects booking",
	...
	"auto_filled_from_map" => "Auto filled from map",
	"comm" => "Comm",
	...
	"preview" => "Preview",
	"filtering_by_trip" => "Filtering by trip",
	...
	"cannot_delete_vehicle_category_in_use" => "Cannot delete: one or more drivers use this category.",
	"Vehicle category saved." => "Vehicle category saved.",
	"Vehicle category updated." => "Vehicle category updated.",
	"Vehicle category activated." => "Vehicle category activated.",
	"Vehicle category deactivated." => "Vehicle category deactivated.",
