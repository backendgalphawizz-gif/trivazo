...
use App\Http\Controllers\RestAPI\v1\HotelController;
...
Route::group(['namespace' => 'RestAPI\v1', 'prefix' => 'v1', 'middleware' => ['api_lang']], function () {
    ...
    Route::group(['prefix' => 'auth', 'namespace' => 'auth'], function () {
        ...
        Route::controller(ForgotPasswordController::class)->group(function () {
            ...
            Route::post('resend-forgot-password-otp', 'resendPasswordResetOtp');
    ...
    Route::group(['prefix' => 'hotels'], function () {
        Route::controller(HotelController::class)->group(function () {
            ...
            Route::get('/', 'getHotelList');
            Route::get('{id}', 'getHotelDetails');
        });
    });
